  ...
  return (
    <>
      ...
      <div className={`leading-normal tracking-normal text-white ${classes.gradient}`}>
        ...
        {/*Hero */}
        <div className="pt-24">
          <div className="container w-full lg:w-3/4 px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
            {/*Left Col*/}
            <div className="flex flex-col w-full md:w-2/5 justify-center items-start text-center md:text-left">
              <p className="uppercase tracking-loose w-full">
                User Friendly way of Creating Sitemaps
              </p>
          ...
          <div className="container max-w-5xl mx-auto m-8">
            ...
            <div className="flex flex-wrap">
              ...
              <div className="w-full sm:w-1/2 p-6">
                <img src="https://www.brainstormindia.com/images/resources/web.jpg" alt="" />
            ...
            <div className="flex flex-wrap flex-col-reverse sm:flex-row">
              <div className="w-full sm:w-1/2 p-6 mt-6">
                ...
                <img src="https://futureskillsprime.in/sites/default/files/2021-04/web-development.jpg" alt="" />
              </div>
              <div className="w-full sm:w-1/2 p-6 mt-6">
        ...
        <section className="bg-white border-b py-8">
          <div className="container mx-auto flex flex-wrap pt-4 pb-12">
            <h2 className="w-full my-2 text-5xl font-bold leading-tight text-center text-gray-800">
              Generate sitemap & wireframe
            </h2>
            <div className="w-full mb-4">
              <div className="h-1 mx-auto gradient w-64 opacity-25 my-0 py-0 rounded-t" />
            </div>
            <div className="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrin">
            ...
            <div className="flex flex-col sm:flex-row justify-center pt-12 my-12 sm:my-4">
              <div className="flex flex-col w-5/6 lg:w-1/4 mx-auto lg:mx-0 rounded-none lg:rounded-l-lg bg-white mt-4">
                <div className="flex-1 bg-white text-gray-600 rounded-t rounded-b-none overflow-hidden shadow">
                  ...
                  <ul className="w-full text-center text-sm">
                    <li className="border-b py-4">limited crawler</li>
                    <li className="border-b py-4">Unlimited pages per site</li>
                    <li className="border-b py-4">Dashboard access</li>
                  </ul>
                </div>
                <div className="flex-none mt-auto bg-white rounded-b rounded-t-none overflow-hidden shadow p-6">
              ...
              <div className="flex flex-col w-5/6 lg:w-1/3 mx-auto lg:mx-0 rounded-lg bg-white mt-4 sm:-mt-6 shadow-lg z-10">
                <div className="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow">
                  ...
                  <ul className="w-full text-center text-base font-bold">
                    <li className="border-b py-4">Pro Wireframe kit</li>
                    <li className="border-b py-4">External link</li>
                    <li className="border-b py-4">Sitemap export (XML, JSON)</li>
                    <li className="border-b py-4">Sitemap Generator for Google</li>
                  </ul>
                </div>
                <div className="flex-none mt-auto bg-white rounded-b rounded-t-none overflow-hidden shadow p-6">
              ...
              <div className="flex flex-col w-5/6 lg:w-1/4 mx-auto lg:mx-0 rounded-none lg:rounded-l-lg bg-white mt-4">
                <div className="flex-1 bg-white text-gray-600 rounded-t rounded-b-none overflow-hidden shadow">
                  ...
                  <ul className="w-full text-center text-sm">
                    <li className="border-b py-4">Private projects</li>
                    <li className="border-b py-4">Team folders</li>
                    <li className="border-b py-4">Move projects between accounts</li>
                  </ul>
                </div>
                <div className="flex-none mt-auto bg-white rounded-b rounded-t-none overflow-hidden shadow p-6">
                  <div className="w-full pt-6 text-3xl text-gray-600 font-bold text-center">
